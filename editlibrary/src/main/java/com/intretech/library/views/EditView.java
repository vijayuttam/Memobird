...
public class EditView extends LinearLayout {
    ...
    private com.intretech.library.views.File addFileOn(int index){
        com.intretech.library.views.File file = new com.intretech.library.views.File(getContext());
        ...
        for (LinkedTreeMap<String, Object> bean : beans){
            ...
            switch (type){
                ...
                case Constants.TYPE_ITEM:
                    ...
                    break;
                case Constants.TYPE_ATT:
                    com.intretech.library.views.File fileView = addFileOn((int) Math.round((Double) bean.get("index")));
